...
const ScannerPage = () => {
    ...
    return (
        ...
        <Box sx={{
            ...
            <Paper elevation={3} sx={{ width: "400px", margin: "auto", marginTop: "5%", padding: "3%", backgroundColor: "#e3eefc" }}>
                ...
                >
                    ...
                    <Typography
                        ...
                        sx={{
                            ...
                            fontFamily: 'Roboto', fontWeight: "bold", fontSize: "2.5rem",color:"#5EBEC4"
                        }}
                    >
